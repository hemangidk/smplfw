...
public class  MySqlUtil {				
    	...
    	public  static void close_connection(Connection c) throws SQLException,ClassNotFoundException
    	{
    		c.close();
    	}
...
public static void updaterow()throws ClassNotFoundException,SQLException
{
 try
	    {
